...
__all__ = [
    'STSF_AppData', 'ISpeechPhraseRules', 'DISPID_SPAPhraseInfo',
    'ISpeechGrammarRuleState', 'SVSFIsNotXML',
    'DISPID_SASNonBlockingIO', 'SFTSREngine', 'DISPID_SRCEAudioLevel',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SpeechAudioStatus',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRGState',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechBaseStream', 'DISPID_SVPriority',
    'SPSMF_SAPI_PROPERTIES', 'SpeechPropertyComplexResponseSpeed',
    'SGDSActiveWithAutoPause', 'SPEI_SR_BOOKMARK',
    'SAFT8kHz16BitStereo', 'SREInterference', 'DISPID_SPEsItem',
    'SpeechTokenShellFolder', 'SPPARTOFSPEECH', 'SPPS_RESERVED1',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVEVoiceChange',
    'DISPID_SPELexicalForm', 'ISpVoice', 'SAFT24kHz16BitMono',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPIReplacements',
    'DISPID_SPIAudioSizeTime', 'DISPID_SOTSetId', 'SVPAlert',
    'DISPID_SPAsItem', 'DISPID_SGRSTRule', 'SPGS_ENABLED',
    'DISPID_SMSGetData', 'eLEXTYPE_PRIVATE18',
    'SpeechDisplayAttributes', 'DISPID_SPCPhoneToId',
    'SpCustomStream', 'ISpSerializeState', 'DISPID_SPPValue',
    'SASClosed', 'SpAudioFormat', 'SRAExport',
    'DISPID_SPRuleConfidence', 'DISPID_SVSLastBookmark',
    'DISPID_SLGetWords', 'SpeechGrammarTagWildcard',
    'DISPID_SRCEPropertyNumberChange', 'SPAR_Low',
    'IEnumSpObjectTokens', 'DISPID_SpeechVoiceStatus',
    'ISpeechAudioStatus', 'DISPID_SOTCSetId', 'ISpeechRecoResult',
    'DISPID_SOTCId', 'SpeechSpecialTransitionType',
    'SPINTERFERENCE_NONE', 'DISPID_SAFSetWaveFormatEx',
    'SAFT11kHz16BitMono', 'DISPID_SRCSetAdaptationData',
    'ISpPhoneticAlphabetSelection', 'SPWF_INPUT',
    'DISPID_SOTCGetDataKey', 'SPFM_NUM_MODES', 'DISPID_SVEAudioLevel',
    'SVEEndInputStream', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRGDictationLoad', 'DISPID_SLWPronunciations',
    'DISPID_SRCERecognition', 'eLEXTYPE_PRIVATE1', 'SpeechTokenKeyUI',
    'DISPID_SPIStartTime', 'DISPID_SVEEnginePrivate', 'SVEPhoneme',
    'SPPS_RESERVED4', 'DISPID_SLPSymbolic',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRSSupportedLanguages',
    'SPEI_PHONEME', 'DISPID_SOTDataKey', 'DISPID_SABIEventBias',
    'SGDisplay', 'SPINTERFERENCE_TOOLOUD', 'SRCS_Enabled',
    'SPEI_FALSE_RECOGNITION', 'SAFT24kHz8BitMono',
    'SPTEXTSELECTIONINFO', 'DISPID_SBSSeek', 'SPEI_TTS_BOOKMARK',
    'DISPID_SOTRemove', 'SPLOADOPTIONS',
    'SpeechStreamSeekPositionType', 'SVP_9',
    'DISPID_SpeechPhraseBuilder', 'SPSHT_Unknown',
    'DISPID_SGRSTPropertyValue', 'SAFTDefault', 'SPSVerb',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRProfile',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SLWType',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SDKEnumKeys',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_USER_SHORTCUT',
    'SRTExtendableParse', 'SPEI_RESERVED3', 'eWORDTYPE_ADDED',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRGCommit',
    'SREHypothesis', 'SPWORDTYPE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVF_Stressed',
    'SpWaveFormatEx', 'DISPID_SDKOpenKey', 'ISpeechPhraseProperty',
    'eLEXTYPE_RESERVED7', 'SAFT24kHz16BitStereo', 'SSTTDictation',
    'DISPID_SWFEBlockAlign', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechPhraseElements', 'SPRECOSTATE', 'DISPID_SLWsCount',
    'SVEBookmark', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPEActualConfidence', 'DISPID_SVGetAudioInputs', 'SVP_15',
    'SPEI_MIN_TTS', 'SP_VISEME_6', 'DISPID_SVPause',
    'SDKLCurrentConfig', 'DISPID_SRCEFalseRecognition',
    'DISPID_SGRAddResource', 'SPVPRIORITY', 'SPEI_MAX_SR',
    'DISPID_SVStatus', 'DISPID_SpeechRecognizer',
    'SpNullPhoneConverter', 'SGLexical', 'SAFTNoAssignedFormat',
    'SPGRAMMARWORDTYPE', 'SRAONone', 'SPSEMANTICERRORINFO',
    'SpeechEngineConfidence', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRRPhraseInfo', 'DISPID_SVSpeak',
    'DISPID_SRCERecognizerStateChange', 'SPSHORTCUTTYPE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpeechVisemeType',
    'DISPID_SRRTStreamTime', 'DISPID_SPRsCount', 'DISPID_SAFGuid',
    'SSFMOpenReadWrite', 'SAFT44kHz8BitStereo',
    'Speech_Max_Word_Length', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRGDictationUnload', 'SRERecognition',
    'SAFT24kHz8BitStereo', 'SPEI_ADAPTATION', 'ISpRecognizer3',
    'STSF_FlagCreate', 'SPAS_STOP', 'SDTAudio',
    'DISPID_SVSLastBookmarkId', 'SITooSlow', 'SpeechVoiceEvents',
    'SAFTADPCM_8kHzStereo', 'SPRECOGNIZERSTATUS', 'SP_VISEME_21',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPRuleId',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRId', 'SVP_5', 'SVPOver',
    'SDTAlternates', 'DISPID_SLAddPronunciation', 'SVF_Emphasis',
    'DISPID_SABIBufferSize', 'IStream', 'DISPID_SRCEEndStream',
    'DISPID_SOTsItem', 'SSSPTRelativeToStart',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVWaitUntilDone',
    'DISPID_SGRSAddWordTransition', 'DISPID_SMSAMMHandle',
    'SpObjectToken', 'SPFM_OPEN_READONLY', 'SREAudioLevel',
    'SPEVENTENUM', '_ISpeechRecoContextEvents', 'SGSExclusive',
    'SRAInterpreter', 'DISPID_SVEViseme', 'ISpeechPhraseReplacement',
    'SECFIgnoreKanaType', 'SpCompressedLexicon', 'SPSERIALIZEDRESULT',
    'SAFT48kHz8BitStereo', 'SGRSTTTextBuffer',
    'SPEI_RECO_STATE_CHANGE', 'SpeechVisemeFeature',
    'DISPID_SRGCmdSetRuleState', 'SpeechPartOfSpeech', 'SVEPrivate',
    'SVSFParseSsml', 'SSTTWildcard', 'SAFT32kHz8BitMono',
    'DISPID_SBSFormat', 'SPLO_DYNAMIC', 'DISPID_SCSBaseStream',
    'SRADynamic', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SITooFast', 'ISpeechPhraseInfoBuilder', 'SAFT11kHz8BitStereo',
    'DISPID_SRGId', 'DISPID_SRRAlternates', 'SP_VISEME_1',
    'ISpeechLexiconWord', 'SPCT_SLEEP', 'SPEVENT',
    'SpeechPropertyNormalConfidenceThreshold', 'STCRemoteServer',
    'SAFT12kHz16BitMono', 'DISPID_SpeechDataKey',
    'DISPID_SGRSTPropertyName', 'DISPID_SVVolume',
    'SpSharedRecoContext', 'SLOStatic', 'SpeechRecoContextState',
    'DISPID_SOTMatchesAttributes', 'SAFTCCITT_uLaw_8kHzMono',
    'SVP_11', 'SDTAll', 'ISpeechFileStream', 'SVP_1',
    'SECFEmulateResult', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRCESoundStart', 'DISPID_SAStatus',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCPause', 'SPEI_RESERVED5',
    'SpeechPropertyResourceUsage', 'DISPID_SRCVoicePurgeEvent',
    'ISpeechVoiceStatus', 'DISPID_SpeechObjectTokenCategory',
    'SDA_Consume_Leading_Spaces', 'SPPS_LMA', 'SVP_20',
    'SPGRAMMARSTATE', 'DISPID_SVGetProfiles', 'DISPID_SLGenerationId',
    'DISPID_SVVoice', 'SAFT22kHz8BitStereo', 'ISpeechObjectTokens',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechGrammarState',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SLODynamic',
    'SWTDeleted', 'SPCATEGORYTYPE', 'DISPID_SPERetainedSizeBytes',
    'SPSHT_NotOverriden', 'DISPID_SGRsCommit', 'SLTUser',
    'DISPIDSPRG', 'DISPID_SRCVoice', 'DISPID_SPIGrammarId',
    'SRSEIsSpeaking', 'SpeechFormatType', 'DISPID_SPILanguageId',
    'SAFTGSM610_44kHzMono', 'DISPID_SRSAudioStatus',
    'DISPID_SRCCmdMaxAlternates', 'SREPropertyNumChange',
    'SPCT_DICTATION', 'SPSLMA', 'SAFT44kHz16BitStereo',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSRule', 'DISPID_SRRecognizer',
    'Speech_Max_Pron_Length', 'ISpStream', 'SRSInactiveWithPurge',
    'SVP_3', 'SP_VISEME_7', 'SPSEMANTICFORMAT', 'SPLEXICONTYPE',
    'ISpStreamFormat', 'DISPID_SRGRules', 'SREPhraseStart',
    'DISPID_SPAsCount', 'SVP_18', 'DISPID_SPEAudioTimeOffset',
    'SRTSMLTimeout', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SVIsUISupported', 'DISPID_SFSClose', 'SpShortcut',
    'DISPID_SRGSetTextSelection', 'SpeechRecoEvents', 'SPPS_Unknown',
    'DISPID_SREmulateRecognition', 'SPEI_WORD_BOUNDARY',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechAudioVolume', 'SVEViseme',
    'DISPID_SOTCreateInstance', 'SAFT48kHz8BitMono',
    'DISPID_SGRAttributes', 'SAFTADPCM_44kHzMono',
    'DISPID_SABIMinNotification', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SGRClear', 'DISPID_SGRsCount', 'SPAUDIOSTATUS',
    'DISPID_SPIGetText', 'SREBookmark', 'SRCS_Disabled',
    'DISPID_SRRSpeakAudio', 'eLEXTYPE_PRIVATE15', 'SPRS_INACTIVE',
    'DISPID_SRRDiscardResultInfo', '_SPAUDIOSTATE',
    'DISPID_SpeechPhraseElement', 'ISpeechResourceLoader',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRGSetWordSequenceData', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SpeechRecoContextEvents', 'SVP_12',
    'DISPID_SPPFirstElement', 'SPRECORESULTTIMES',
    'SpeechPropertyResponseSpeed', 'SINoise',
    'SpPhoneticAlphabetConverter', 'SAFT48kHz16BitMono',
    'SPAR_Medium', 'SPCS_ENABLED', 'DISPID_SPPs_NewEnum',
    'DISPID_SPERetainedStreamOffset', 'SpResourceManager',
    'SpeechAudioFormatGUIDText', 'SPPS_RESERVED2', 'DISPID_SGRSTText',
    'SRSActive', 'SpeechRegistryUserRoot', 'SRADefaultToActive',
    'SpeechBookmarkOptions', 'DISPID_SDKCreateKey',
    'Speech_StreamPos_RealTime', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechLexicon', 'DISPID_SPAStartElementInResult',
    'DISPID_SpeechLexiconWord', 'DISPID_SPPName', 'SPPS_Verb',
    'SVSFParseAutodetect', 'SPWT_DISPLAY', 'SpeechTokenKeyFiles',
    'DISPID_SGRsItem', 'SpeechLoadOption', 'STSF_CommonAppData',
    'DISPID_SpeechPhraseRules', 'ISpRecoCategory', 'SPRS_ACTIVE',
    'SAFT22kHz16BitStereo', 'DISPID_SPCLangId', 'DISPID_SPRulesCount',
    'DISPID_SVEventInterests', 'SpMMAudioIn', 'DISPID_SMSSetData',
    'DISPID_SRGetRecognizers', 'SPEI_END_SR_STREAM', 'SP_VISEME_13',
    'SpInProcRecoContext', 'DISPID_SABufferNotifySize',
    'SP_VISEME_18', 'DISPID_SRCBookmark', 'eLEXTYPE_MORPHOLOGY',
    'SRSInactive', 'DISPID_SpeechRecoContext',
    'tagSPTEXTSELECTIONINFO', 'SPLO_STATIC', 'SpeechVoicePriority',
    'SpeechWordType', 'SPBO_AHEAD', 'DISPID_SOTGetAttribute',
    'SPFILEMODE', 'SECFIgnoreCase', 'SpeechDictationTopicSpelling',
    'DISPID_SDKSetBinaryValue', 'ISpResourceManager', 'DISPID_SOTId',
    'SP_VISEME_3', 'SPEI_RESERVED1', 'SAFT16kHz8BitMono',
    'SPPS_Interjection', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpeechAudioBufferInfo', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SASStop', 'DISPID_SDKGetStringValue', 'SPCT_SUB_COMMAND',
    'DISPID_SLWWord', 'ISpEventSource', 'DISPID_SpeechAudioFormat',
    'SVSFParseMask', 'DISPID_SpeechRecoResult2', 'SpMMAudioOut',
    'ISpeechPhraseRule', 'SPEI_HYPOTHESIS',
    'DISPID_SPEDisplayAttributes', 'ISpObjectTokenCategory',
    'ISpShortcut', 'SPEI_RESERVED6', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTADPCM_44kHzStereo',
    'SpeechAudioState', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPANumberOfElementsInResult', 'SPXRO_SML', 'SGRSTTWord',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCEHypothesis',
    '__MIDL_IWinTypes_0009', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechPhraseAlternate', 'ISpeechBaseStream',
    'DISPID_SPIElements', 'eLEXTYPE_PRIVATE20', 'eLEXTYPE_PRIVATE5',
    'STCInprocServer', 'SVP_17', 'DISPID_SpeechObjectTokens',
    'DISPID_SpeechPhraseReplacement', 'SECHighConfidence',
    'SAFT22kHz16BitMono', 'SPWT_PRONUNCIATION', 'SPSHT_EMAIL',
    'SPRST_ACTIVE', 'DISPID_SPEsCount', 'DISPID_SGRSTWeight',
    'SVP_19', 'DISPID_SRCCreateGrammar', 'SPCS_DISABLED',
    'DISPID_SpeechLexiconWords', 'DISPID_SRCEAdaptation',
    'SpeechRuleState', 'SRSEDone', 'SPVPRI_NORMAL',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPDKL_CurrentUser',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SDKSetStringValue',
    'DISPID_SPRText', 'SPCONTEXTSTATE', 'SPGS_EXCLUSIVE',
    'SP_VISEME_19', 'ISpProperties', 'SWPUnknownWordPronounceable',
    'DISPID_SRGCmdSetRuleIdState', 'SGRSTTEpsilon',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SGRSTPropertyId',
    'SpPhraseInfoBuilder', 'ISpPhrase', 'SVEVoiceChange',
    'eLEXTYPE_APP', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPRNumberOfElements', 'SpeechCategoryAppLexicons',
    'SAFT16kHz8BitStereo', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SAFT44kHz8BitMono', 'SGRSTTDictation', 'ISpeechLexiconWords',
    'ISpeechPhraseProperties', 'SPAS_RUN', 'DISPID_SRRTTickCount',
    'DISPID_SGRSTNextState', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechGrammarRules', 'SPBO_NONE', 'SVSFDefault',
    'DISPID_SMSALineId', 'DISPID_SPPParent', 'DISPID_SAVolume',
    'SSTTTextBuffer', 'DISPID_SRDisplayUI', 'DISPID_SRRAudio',
    'SVESentenceBoundary', 'SSFMCreate', 'SAFT8kHz8BitStereo',
    'tagSTATSTG', 'SSSPTRelativeToEnd', 'DISPID_SPRuleFirstElement',
    'SGLexicalNoSpecialChars', 'ISpRecoResult',
    'DISPID_SPIRetainedSizeBytes', 'SVSFNLPSpeakPunc', 'SPSMF_UPS',
    'ISpRecognizer2', 'DISPID_SVEPhoneme',
    'DISPID_SpeechAudioBufferInfo', 'SPRULE', 'SPBOOKMARKOPTIONS',
    'SP_VISEME_11', 'SAFTCCITT_ALaw_11kHzMono', 'SPFM_CREATE_ALWAYS',
    'SPINTERFERENCE_TOOFAST', 'SPEVENTSOURCEINFO', 'SBOPause',
    'SVP_21', 'DISPID_SPPId', 'SDA_Two_Trailing_Spaces',
    'SpeechCategoryRecoProfiles', 'SpeechVoiceSpeakFlags',
    'SpeechAddRemoveWord', 'SpUnCompressedLexicon', 'SRTAutopause',
    'ISpNotifyTranslator', 'SVSFUnusedFlags', 'SRESoundStart',
    'SpeechRetainedAudioOptions', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTADPCM_22kHzStereo', 'SECNormalConfidence',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPCIdToPhone',
    'SpeechPropertyAdaptationOn', 'DISPID_SOTs_NewEnum',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRGDictationSetState',
    'eLEXTYPE_PRIVATE16', 'SP_VISEME_15', 'SpeechLexiconType',
    'SDKLCurrentUser', 'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechPhoneConverter', 'SRERecoOtherContext',
    'SPVOICESTATUS', 'SRSActiveAlways', 'SDTDisplayText',
    'DISPID_SRCRequestedUIType', 'ISpeechObjectTokenCategory',
    'SAFTText', 'SPXRO_Alternates_SML', 'DISPID_SRGetPropertyString',
    'DISPID_SGRSTs_NewEnum', 'SSFMOpenForRead', 'SVSFParseSapi',
    'SPEI_START_INPUT_STREAM', 'DISPID_SGRSTransitions',
    'DISPID_SVRate', 'SDA_One_Trailing_Space',
    'SPEI_SR_RETAINEDAUDIO', 'SAFT32kHz16BitStereo',
    'SPSNotOverriden', 'SpeechMicTraining', 'SpStream',
    'DISPID_SADefaultFormat', 'SP_VISEME_4', 'STCAll', 'SRERequestUI',
    'SPXMLRESULTOPTIONS', 'SPAS_PAUSE', 'STSF_LocalAppData',
    'SPPHRASEPROPERTY', 'DISPID_SOTIsUISupported',
    'DISPID_SLRemovePronunciation', 'DISPID_SPRs_NewEnum',
    'SINoSignal', 'IInternetSecurityManager',
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_PRIVATE7',
    'SAFTGSM610_22kHzMono', 'SVP_10', 'SECLowConfidence',
    'SGRSTTWildcard', 'ISpMMSysAudio', 'SREStreamEnd',
    'DISPID_SDKDeleteValue',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVSPhonemeId',
    'SPEI_VOICE_CHANGE', 'SP_VISEME_14', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSRunningState',
    'DISPID_SLWsItem', 'DISPID_SRGCmdLoadFromFile',
    'SAFT16kHz16BitMono', 'SpPhoneConverter', 'SPFM_OPEN_READWRITE',
    'DISPID_SpeechGrammarRuleStateTransition', 'SASPause',
    'DISPID_SPIRule', 'SPPS_Noncontent', 'DISPID_SPIEngineId',
    ...
    'DISPID_SPPNumberOfElements', 'SRARoot', 'DISPID_SRIsShared',
    'SPBO_PAUSE', 'SPEI_UNDEFINED', 'ISpXMLRecoResult',
    'DISPID_SRSCurrentStreamNumber', 'SPADAPTATIONRELEVANCE',
    'DISPID_SLWLangId', 'DISPID_SOTCategory', 'ISpRecoGrammar2',
    'SVP_13', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPEAudioStreamOffset', 'SPPS_SuppressWord',
    'SDKLLocalMachine', 'SpeechCategoryRecognizers',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRGCmdLoadFromObject',
    'SPPHRASE', 'DISPID_SPEAudioSizeTime', 'SITooQuiet',
    'SAFTADPCM_11kHzMono', 'SpeechTokenKeyAttributes',
    'SPWF_SRENGINE', 'DISPID_SpeechPhraseRule', 'SPSERIALIZEDPHRASE',
    'SRTEmulated', 'DISPID_SpeechPhraseProperty', 'DISPID_SLPType',
    'DISPID_SPEAudioSizeBytes', 'SPDKL_CurrentConfig',
    'eLEXTYPE_PRIVATE2', 'UINT_PTR', 'DISPID_SpeechPhraseAlternates',
    'eLEXTYPE_PRIVATE13', 'SPAR_High', 'DISPID_SRGReset',
    'ISpStreamFormatConverter', 'SpeechCategoryPhoneConverters',
    'SPAUDIOSTATE', 'DISPID_SVSInputWordLength', 'SREPrivate',
    'SVP_2', 'ISpeechRecoResult2', 'SpeechCategoryAudioIn',
    'SGSEnabled', 'SPSModifier', 'SVSFlagsAsync', 'SREStateChange',
    'SPSSuppressWord', 'SP_VISEME_20', 'ISpRecoContext2',
    'DISPID_SRState', 'SGDSActiveUserDelimited', 'SECFNoSpecialChars',
    'DISPID_SPIProperties', 'SVSFNLPMask', 'SAFT8kHz8BitMono',
    'ISpObjectWithToken', 'DISPID_SPPChildren', 'eLEXTYPE_PRIVATE12',
    'DISPID_SLPsCount', 'SPSNoun', 'DISPID_SpeechRecoResult',
    'DISPID_SLPPhoneIds', 'SpeechRecognitionType', 'SVEAudioLevel',
    'SPPS_NotOverriden', 'DISPID_SVSLastResult', 'DISPID_SVEBookmark',
    'ISpGrammarBuilder', 'SVSFPersistXML', 'SDTPronunciation',
    'DISPID_SLGetPronunciations', 'SREStreamStart',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechAudioFormatGUIDWave',
    'ISpeechLexiconPronunciation', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVGetVoices', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechCategoryAudioOut', 'SVEStartInputStream',
    'SpTextSelectionInformation', 'IInternetSecurityMgrSite',
    'DISPID_SGRSAddSpecialTransition', 'SRAImport',
    'eLEXTYPE_RESERVED4', 'SPPHRASEELEMENT',
    'DISPID_SPIGetDisplayAttributes', 'SPRULESTATE',
    'DISPID_SPRuleEngineConfidence', 'ISpPhoneConverter',
    'DISPID_SPRuleChildren', 'SpSharedRecognizer',
    'ISpeechPhraseElement', 'DISPID_SGRAddState', 'LONG_PTR',
    'SPPS_RESERVED3', 'ISpeechRecoResultTimes', 'ISpNotifySource',
    'DISPID_SPRFirstElement', 'ISpeechPhraseElements',
    'DISPID_SGRSTsItem', 'SPEI_START_SR_STREAM', 'SPFM_CREATE',
    'DISPID_SDKGetBinaryValue', 'SGDSInactive',
    'DISPID_SPIAudioSizeBytes', 'ISpPhraseAlt', 'ISpeechAudioFormat',
    ...
    'SAFTCCITT_uLaw_11kHzMono', 'SPEI_SENTENCE_BOUNDARY',
    'SPSTREAMFORMATTYPE', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechCustomStream', 'SPPS_Modifier',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVSInputWordPosition',
    'DISPID_SVSInputSentenceLength', 'DISPID_SLPs_NewEnum',
    'SpeechCategoryVoices', 'ISpeechWaveFormatEx',
    'SAFTNonStandardFormat', 'SPRST_INACTIVE', 'DISPID_SWFEExtraData',
    'SBONone', 'SPAO_NONE', 'DISPID_SLGetGenerationChange',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechMemoryStream', 'SPPROPERTYINFO', 'SPPHRASERULE',
    'SPEI_REQUEST_UI', 'SpInprocRecognizer', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechGrammarRuleState', 'SECFDefault',
    'DISPID_SGRSTType', 'DISPID_SOTGetStorageFileName',
    'SpStreamFormatConverter', 'SREAllEvents', 'SP_VISEME_10',
    'DISPID_SRSetPropertyNumber', 'SpeechDiscardType',
    'ISpeechGrammarRule', 'SVP_7', 'SPVPRI_ALERT', 'SPPS_Function',
    'DISPID_SPPConfidence', 'SPBO_TIME_UNITS', 'DISPID_SABufferInfo',
    'SPAS_CLOSED', 'DISPID_SVAudioOutput',
    'DISPID_SRSCurrentStreamPosition', 'SPINTERFERENCE_NOISE',
    'SPRST_NUM_STATES', 'DISPID_SMSADeviceId', 'SPWORDLIST',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRRTOffsetFromStart',
    'eLEXTYPE_PRIVATE11', 'SECFIgnoreWidth', 'DISPID_SGRsFindRule',
    'DISPIDSPTSI_SelectionLength',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpEventSink',
    'ISpeechRecognizer', 'DISPID_SPRules_NewEnum', 'SPSHORTCUTPAIR',
    'SVEAllEvents', 'SPEI_PHRASE_START', 'DISPID_SASetState',
    'DISPID_SWFEChannels', 'SDTProperty', 'SDKLDefaultLocation',
    'ISpObjectToken', 'SAFT12kHz16BitStereo', 'DISPID_SRGRecoContext',
    'SDA_No_Trailing_Space', 'SPWAVEFORMATTYPE',
    'SAFT32kHz8BitStereo', 'DISPID_SGRsDynamic', 'SPVPRI_OVER',
    'ISpeechXMLRecoResult', 'DISPID_SRRSetTextFeedback',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechGrammarRule',
    'DISPID_SRIsUISupported', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SGRName', 'DISPID_SPIEnginePrivateData',
    'DISPID_SVAudioOutputStream', 'ISpeechTextSelectionInformation',
    'DISPID_SOTDisplayUI', 'eLEXTYPE_PRIVATE14', 'ISpAudio',
    'ISpRecoGrammar', 'DISPID_SpeechAudio', 'DISPID_SPRulesItem',
    'ISpeechGrammarRules', 'DISPID_SPRsItem', 'SAFT48kHz16BitStereo',
    'DISPID_SRGIsPronounceable',
    'SpeechGrammarRuleStateTransitionType', '_ISpeechVoiceEvents',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechEngineProperties',
    'eWORDTYPE_DELETED', 'ISpeechRecognizerStatus', 'IEnumString',
    'SAFTCCITT_ALaw_22kHzMono', 'eLEXTYPE_PRIVATE8',
    'SPDKL_DefaultLocation', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechLexiconPronunciation', 'SPSUnknown',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCERequestUI', 'SP_VISEME_9',
    'tagSPPROPERTYINFO', 'SAFT11kHz16BitStereo', 'SAFTADPCM_8kHzMono',
    'SpeechDataKeyLocation', 'SP_VISEME_16', 'SVP_8', 'DISPIDSPTSI',
    'ISpRecognizer', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechPhraseAlternates', 'SpeechRuleAttributes',
    'SpeechTokenContext', 'SPSHT_OTHER', 'SpMMAudioEnum',
    'DISPID_SRCEPhraseStart', 'SPAUDIOBUFFERINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SINone', 'SWTAdded',
    'SGRSTTRule', 'SAFT22kHz8BitMono', 'SWPKnownWordPronounceable',
    'DISPID_SpeechFileStream', 'SPSFunction', 'DISPID_SRAudioInput',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SASState', 'ISpNotifySink',
    'SITooLoud', 'DISPID_SRCESoundEnd', 'SAFT12kHz8BitMono',
    'ISpeechPhoneConverter', 'DISPID_SPPEngineConfidence',
    'SAFT11kHz8BitMono', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SDKGetlongValue', 'SRAORetainAudio', 'ISpeechRecoGrammar',
    'SVP_16', 'SpeechStreamFileMode', 'DISPID_SPRuleName',
    'SpeechWordPronounceable', 'SPSHORTCUTPAIRLIST',
    'DISPID_SWFESamplesPerSec', 'SVP_0',
    'SSSPTRelativeToCurrentPosition', 'SAFTExtendedAudioFormat',
    'DISPID_SBSWrite', 'SpeechTokenValueCLSID', 'STCLocalServer',
    'DISPID_SRAudioInputStream', 'DISPID_SPISaveToMemory',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SDKSetLongValue',
    'Speech_StreamPos_Asap', 'SAFT32kHz16BitMono',
    'ISpeechLexiconPronunciations', 'SAFT44kHz16BitMono',
    'ISpeechLexicon', 'DISPID_SRSClsidEngine', 'SPEI_MAX_TTS',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRRTimes',
    'SP_VISEME_17', 'DISPID_SpeechRecognizerStatus', 'DISPID_SFSOpen',
    'SPBINARYGRAMMAR', 'SVP_14', 'DISPID_SRGetFormat',
    'DISPID_SASCurrentDevicePosition', 'SPWT_LEXICAL',
    'SVSFVoiceMask', 'DISPID_SBSRead', 'SpeechGrammarWordType',
    'SRTReSent', 'DISPID_SRRRecoContext', 'SpFileStream',
    'DISPID_SPRuleParent', 'DISPID_SGRSTsCount', 'SP_VISEME_12',
    'SGSDisabled', 'DISPID_SAEventHandle',
    'DISPID_SVSInputSentencePosition', 'SpNotifyTranslator',
    'SP_VISEME_5', 'SpeechAllElements', 'SP_VISEME_8', 'ISpeechAudio',
    'SPDATAKEYLOCATION', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCERecognitionForOtherContext', 'ISpLexicon',
    'SPEI_SR_PRIVATE', 'SpeechRegistryLocalMachineRoot',
    '_RemotableHandle', 'Speech_Default_Weight',
    'DISPID_SRCRetainedAudioFormat', 'SPCT_COMMAND',
    'DISPID_SPACommit', 'DISPID_SRCRecognizer',
    'DISPID_SRCEStartStream', 'ISpDataKey', 'DISPID_SVDisplayUI',
    'DISPID_SRCResume', 'ISpeechPhraseAlternate',
    'SAFT12kHz8BitStereo', 'SPPS_Noun', 'SDTLexicalForm',
    ...
    'DISPID_SRRGetXMLResult', 'SpMemoryStream',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCreateRecoContext', 'DISPID_SOTCDefault',
    'DISPID_SRRGetXMLErrorInfo', 'SFTInput', 'SpeechRunState',
    'SASRun', 'DISPID_SWFEFormatTag', 'DISPID_SGRsAdd',
    'SREAdaptation', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE17',
    'ISpeechCustomStream', 'DISPID_SLPsItem', 'SPVISEMES',
    'eLEXTYPE_USER', 'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechVoiceEvent', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SVSVisemeId', 'SAFTCCITT_uLaw_22kHzMono', 'SVP_4',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechVoice',
    'DISPIDSPTSI_SelectionOffset', 'ISpeechMMSysAudio',
    'ISpPhoneticAlphabetConverter', 'SPEI_RESERVED2',
    'SPWORDPRONUNCIATION', 'ISpRecoContext', 'SP_VISEME_2',
    'DISPID_SRCRetainedAudio', 'DISPID_SVEStreamEnd', 'SGDSActive',
    'SVSFPurgeBeforeSpeak', 'SPINTERFERENCE', 'DISPID_SAFType',
    'SPAUDIOOPTIONS', 'SPGS_DISABLED', 'SPEI_SOUND_START',
    'ISequentialStream', 'DISPID_SpeechPhraseInfo', 'SLTApp',
    'SpLexicon', 'SRESoundEnd', 'DISPID_SPPsItem', 'DISPID_SRStatus',
    'DISPID_SVResume', 'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVSkip',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechGrammarRuleStateTransition',
    'SPEI_VISEME', 'SVPNormal', 'SPEI_SOUND_END',
    'SpeechGrammarTagDictation',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTGSM610_8kHzMono',
    'DISPID_SRSetPropertyString', 'DISPID_SRRAudioFormat',
    'DISPID_SGRs_NewEnum', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRCState',
    'SREFalseRecognition', 'SPEI_TTS_PRIVATE', 'DISPID_SVEWord',
    'eLEXTYPE_RESERVED8', 'SDTRule', 'SVP_6', 'SAFT8kHz16BitMono',
    'DISPID_SPPsCount', 'SPEI_END_INPUT_STREAM', 'SP_VISEME_0',
    'SPWORD', 'SGPronounciation', 'DISPID_SOTGetDescription',
    'DISPID_SpeechObjectToken', 'DISPID_SOTsCount',
    'DISPID_SPEDisplayText', 'SpeechRecognizerState',
    'ISpeechObjectToken', 'DISPID_SVSpeakStream', 'SRTStandard',
    'ISpeechRecoContext', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SVEStreamStart', 'ISpeechRecoResultDispatch',
    'SpeechEmulationCompareFlags', 'SVF_None',
    'DISPID_SRCEEnginePrivate', 'DISPID_SRCEInterference',
    'SpeechAudioFormatType', 'SpeechPropertyHighConfidenceThreshold',
    'WAVEFORMATEX', 'DISPID_SLPLangId', 'SpeechInterference',
    'eLEXTYPE_RESERVED6', 'DISPID_SPARecoResult',
    'SPDKL_LocalMachine', 'ISpeechPhraseReplacements',
    'DISPID_SpeechPhraseReplacements', 'SVSFIsXML',
    'DISPID_SRCEBookmark', 'SDTReplacement', 'SSFMCreateForWrite',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechDataKey',
    'SPPHRASEREPLACEMENT', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SVSFIsFilename', 'SPEI_MIN_SR', 'DISPID_SDKEnumValues',
    'SAFT16kHz16BitStereo', 'STCInprocHandler', 'SPEI_INTERFERENCE',
    'ISpeechVoice', 'ISpeechMemoryStream', 'DISPID_SPEPronunciation',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPAR_Unknown',
    'SpObjectTokenCategory'
]

_check_version('1.2.0', 1699238321.827555)
